...
description: "Install the ContentHero skill per host, the paste-prompt one-liner, and authentication."
---

The skill installs from the GitHub repo [`contenthero-ai/skills`](https://github.com/contenthero-ai/skills), not from npm. The repo path is the identifier.
