...
<Steps>
  ...
  <Step title="Read the voice">
    `get_brand_kit` with `detail: "summary"` to see what the kit holds, then with `tabs: ["voice"]` for the voice sections. Summarize the tone and the principles it writes by back in a line.
  </Step>
  <Step title="Cache it">
