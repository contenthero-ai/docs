---
title: "Quickstart"
description: "From concept to content in a few minutes. Pick a transport, authenticate, generate, poll."
---

From concept to content in a few minutes. Pick the transport that matches how you work: an agent host with MCP, a shell with the CLI, or raw HTTP.
