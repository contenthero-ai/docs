...
ContentHero gives your agent two things: the **grounding** to make content that sounds like you, and the **execution** to produce and ship it.
...
<CardGroup cols={2}>
  ...
  <Card title="Execution" icon="bolt">
    Generate the media, assemble the post, schedule it, publish it. The work, done through one surface.
  </Card>
</CardGroup>

Your agent brings the intelligence. ContentHero brings the context and the muscle. When your agent drafts copy, it grounds the draft in your real context (your outliers, brand voice, and past posts) and shows it to you for approval before anything ships.
