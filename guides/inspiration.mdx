...
Inspiration is the research layer. It reads the accounts you track, the outliers (top-performing content) from them, and your own brand-account performance. It is the grounding the [pipeline](/guides/pipeline) draws on before any draft.
