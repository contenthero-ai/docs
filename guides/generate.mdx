...
The generate surface turns an idea into media. It is **execution only**: you bring the prompt, ContentHero produces the asset. Drafting the prompt in the user's voice is the [pipeline](/guides/pipeline)'s job, not this one.
