...
<Steps>
  ...
  <Step title="Read the voice">
    `get_brand_kit` with `detail: "summary"` to see what the kit holds, then with `tabs: ["voice"]` for the voice fields. Summarize the tone, key vocabulary, and anything to avoid back in a line.
  </Step>
  <Step title="Cache it">
