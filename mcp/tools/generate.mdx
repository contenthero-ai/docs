...
Create images, video, audio and boards, upscale them, and check what a generation is doing. 15 tools.
...
<ParamField body name="modelId" type="`nano-banana-2` \| `nano-banana` \| `nano-banana-pro` \| `seedream-5-lite` \| `gpt-image-2` \| `flux-2-pro` \| `flux-1-kontext`" required>
...
<ParamField body name="mode" type="string">
Variant mode for models that expose one: flux-2-pro takes "pro" or "flex"; flux-1-kontext takes "pro" or "max". Affects both the variant and the price. Ignored by models without a mode.
</ParamField>
...
<ParamField body name="seed" type="integer">
...
The editor project to preview.
</ParamField>

<ParamField body name="fromFrame" type="integer">
Start timeline frame of the range. Omit to start at the beginning.
</ParamField>
...
The bucketName returned by create_preview.
</ParamField>

<ParamField body name="renderId" type="string" required>
The renderId returned by create_preview.
</ParamField>
