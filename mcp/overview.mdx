...
<CardGroup cols={3}>
  <Card title="Claude Code" icon="/icons/claude.svg" href="/mcp/claude-code" />
  ...
  <Card title="Codex" icon="/icons/openai.svg" href="/mcp/codex" />
  ...
  <Card title="OpenClaw" icon="shrimp" href="/mcp/openclaw" />
