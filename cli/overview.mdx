...
The `contenthero` CLI drives the full surface from a shell. It is the right transport when you do not have MCP wired up but you have a terminal, and it is ideal for CI and scripts. It rides the same `/api/v1` surface as the SDK.
