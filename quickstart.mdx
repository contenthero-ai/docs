---
title: "Quickstart"
description: "From concept to content in minutes. Pick a transport, authenticate, generate, poll."
---
...
<Tabs>
  <Tab title="MCP">
    Call `get_generation_status` with the `outputId`. It blocks until the render finishes by default; pass `wait: false` for an instant snapshot.
  </Tab>
  <Tab title="CLI">
    ```bash
...
<CardGroup cols={2}>
  ...
  <Card title="Install the skill" icon="robot" href="/skills/overview">
